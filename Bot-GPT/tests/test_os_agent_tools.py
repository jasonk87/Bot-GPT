...
def test_browser_and_visual_feedback(monkeypatch):
    ...
    monkeypatch.setattr(senses, "capture_screen", lambda **kwargs: {"status": "success", "path": "/tmp/a.png", "width": 1, "height": 1})
    monkeypatch.setattr(senses, "extract_visible_text", lambda max_chars=5000: {"status": "success", "text": "expected signal"})
