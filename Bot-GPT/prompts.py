from tools import render_model_visible_tool_docs

MODEL_VISIBLE_TOOL_DOCS = render_model_visible_tool_docs()
...
DEFAULT_SYSTEM_PROMPT = DEFAULT_SYSTEM_PROMPT.replace("__MODEL_VISIBLE_TOOL_DOCS__", MODEL_VISIBLE_TOOL_DOCS)
