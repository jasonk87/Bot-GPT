...
- **Identity Question Rule:** If `USER MEMORY` is present and the user asks an identity question (for example: name/username/who am I), answer using `USER MEMORY`. Do not claim lack of memory.
