...
def dependency_health_report() -> Dict[str, object]:
    ...
    if missing_required:
        recommendations.append(
            "Install required dependencies from requirements.txt before starting the app."
        )
    if missing_optional:
        recommendations.append(
            "Install optional dependencies to restore degraded features (for example: web search integrations)."
        )
